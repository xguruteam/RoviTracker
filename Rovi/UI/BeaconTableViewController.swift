...
class BeaconTableViewController: UITableViewController, BeaconTrackerDelegate {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let aci = UIActivityIndicatorView(style: .gray)
        view.addSubview(aci)
        aci.startAnimating()
        return view
    }
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell!.textLabel?.text = "\(beacon.major.intValue)-\(beacon.minor.intValue)  " + String(format:"(%02X-%02X)", beacon.major.intValue, beacon.minor.intValue)
